...
const Footer =() => {
    return(
        <footer className="flex flex-col py-4 px-8 text-white mt-8 pb-[5rem]">
            <div className="grid grid-cols-[1fr] md:grid-cols-[1fr_1fr] lg:grid-cols-[1fr_1fr_1fr] gap-8">
            ...
            <div className="flex flex-col items-center">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center p-2 transation-all duration-[.25s] hover:translate-x-[-1rem] cursor-pointer mt-4">
                        <Location />
                        <p className="mr-4 text-sm text-gray-100">
                    ...
                    <div className="flex items-center p-2 transation-all duration-[.25s] hover:translate-x-[-1rem] cursor-pointer ">
                        <CellPhone />
                        <a href="tel:+9890123456789" className="mr-4 text-sm text-gray-100">
                            تلفن : 3888888
                        </a>
                    </div>
                    <div className="flex items-center p-2 transation-all duration-[.25s] hover:translate-x-[-1rem] cursor-pointer ">
                    ...
                    <div className="flex items-center p-2 transation-all duration-[.25s] hover:translate-x-[-1rem] cursor-pointer ">
                        <Mail />
                        <a href="mailto:zomorodinfo@gmail.com" className="mr-4 text-sm text-gray-100">
